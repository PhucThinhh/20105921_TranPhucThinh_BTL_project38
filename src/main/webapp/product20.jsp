    ...
    <form action="AddToCartServlet" method="post">
        ...
        <div class="container">
            <div class="product-image">
                <img src="img/20.jpg" alt="Product Image" width="500">
            </div>
            <div class="product-details">
                <div class="product-title">Túi đeo chéo da nữ thiết kế trần trám Yuumy Seasand YN136D màu đen</div>
                <div class="price">299,000đ <span class="old-price">520,000đ</span></div>
