    ...
    <form action="AddToCartServlet" method="post">
        ...
        <div class="container">
            <div class="product-image">
                <img src="img/21.jpg" alt="Product Image" width="500">
            </div>
            <div class="product-details">
                <div class="product-title">Túi đeo chéo da nữ nắp gập dáng vuông cá tính Yuumy Seasand YN197XN màu xanh ngọc</div>
                <div class="price">399,000đ <span class="old-price">540,000đ</span></div>
