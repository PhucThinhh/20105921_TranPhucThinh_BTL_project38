    ...
    <form action="AddToCartServlet" method="post">
        ...
        <div class="container">
            <div class="product-image">
                <img src="img/30.jpg" alt="Product Image" width="500">
            </div>
            <div class="product-details">
                <div class="product-title">Balo da nữ thiết kế tối giản phong cách trẻ trung Yuumy Seasand YBA96K màu kem</div>
                <div class="price">269,000₫ <span class="old-price">480,000₫</span></div>
