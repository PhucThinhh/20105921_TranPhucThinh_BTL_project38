    ...
    <form action="AddToCartServlet" method="post">
        ...
        <div class="container">
            <div class="product-image">
                <img src="img/22.jpg" alt="Product Image" width="500">
            </div>
            <div class="product-details">
                <div class="product-title">Túi đeo chéo da nữ họa tiết caro Yuumy Seasand YN140D Màu đen</div>
                <div class="price">339,000đ <span class="old-price">650,000đ</span></div>
