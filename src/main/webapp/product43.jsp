    ...
    <form action="AddToCartServlet" method="post">
        ...
        <div class="container">
            <div class="product-image">
                <img src="img/40.jpg" alt="Product Image" width="500">
            </div>
            <div class="product-details">
                <div class="product-title">Balo da nữ thời trang đơn giản Yuumy Seasand YBA81XN màu xanh ngọc</div>
                <div class="price">349,000đ <span class="old-price">560,000đ</span></div>
