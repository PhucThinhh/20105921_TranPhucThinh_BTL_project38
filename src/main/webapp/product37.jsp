    ...
    <form action="AddToCartServlet" method="post">
        ...
        <div class="container">
            <div class="product-image">
                <img src="img/34.jpg" alt="Product Image" width="500">
            </div>
            <div class="product-details">
                <div class="product-title">Túi đeo chéo khóa xoay Yuumy Seasand YN142XN màu Xanh ngọc</div>
                <div class="price">355,000đ <span class="old-price">650,000đ</span></div>
