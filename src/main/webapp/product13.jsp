    ...
    <form action="AddToCartServlet" method="post">
        ...
        <div class="container">
            <div class="product-image">
                <img src="img/13.jpg" alt="Product Image" width="500">
            </div>
            <div class="product-details">
                <div class="product-title">Túi đeo chéo da nữ thiết kế phối khóa trang trí Yuumy Seasand YN186D màu đen</div>
                <div class="price">379,000đ <span class="old-price">650,000đ</span></div>
