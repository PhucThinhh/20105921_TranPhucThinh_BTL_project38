    ...
    <form action="AddToCartServlet" method="post">
        ...
        <div class="container">
            <div class="product-image">
                <img src="img/38.jpg" alt="Product Image" width="500">
            </div>
            <div class="product-details">
                <div class="product-title">Túi đeo chéo da nữ kiểu dáng đơn giản Yuumy Seasand YN183T màu trắng</div>
                <div class="price">335,000đ <span class="old-price">520,000đ</span></div>
