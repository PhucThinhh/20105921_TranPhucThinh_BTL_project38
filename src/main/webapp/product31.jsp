    ...
    <form action="AddToCartServlet" method="post">
        ...
        <div class="container">
            <div class="product-image">
                <img src="img/28.jpg" alt="Product Image" width="500">
            </div>
            <div class="product-details">
                <div class="product-title">Ví da nữ cầm tay mini dáng đứng gập đôi tiện dụng Yuumy Seasand YV96K màu kem</div>
                <div class="price">129,000₫ <span class="old-price">180,000₫</span></div>
