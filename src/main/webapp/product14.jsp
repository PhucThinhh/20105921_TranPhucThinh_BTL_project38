    ...
    <form action="AddToCartServlet" method="post">
        ...
        <div class="container">
            <div class="product-image">
                <img src="img/14.jpg" alt="Product Image" width="500">
            </div>
            <div class="product-details">
                <div class="product-title">Túi đeo chéo da nữ thiết kế phối khóa trang trí Yuumy Seasand YN186K màu kem</div>
                <div class="price">550,000đ <span class="old-price">0đ</span></div>
