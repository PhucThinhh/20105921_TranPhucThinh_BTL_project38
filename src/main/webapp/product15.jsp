    ...
    <form action="AddToCartServlet" method="post">
        ...
        <div class="container">
            <div class="product-image">
                <img src="img/15.jpg" alt="Product Image" width="500">
            </div>
            <div class="product-details">
                <div class="product-title">Túi đeo chéo khóa xoay Yuumy Seasand YN142K màu Kem</div>
                <div class="price">550đ,000đ <span class="old-price">0đ</span></div>
