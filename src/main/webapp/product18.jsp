    ...
    <form action="AddToCartServlet" method="post">
        ...
        <div class="container">
            <div class="product-image">
                <img src="img/18.jpg" alt="Product Image" width="500">
            </div>
            <div class="product-details">
                <div class="product-title">Balo da nữ công sở đựng laptop cỡ lớn Yuumy Seasand YBA77KT Màu kem tây</div>
                <div class="price">620,000đ <span class="old-price">0đ</span></div>
