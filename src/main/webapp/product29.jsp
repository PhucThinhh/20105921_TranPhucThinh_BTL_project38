    ...
    <form action="AddToCartServlet" method="post">
        ...
        <div class="container">
            <div class="product-image">
                <img src="img/26.jpg" alt="Product Image" width="500">
            </div>
            <div class="product-details">
                <div class="product-title">Ví da nữ cầm tay mini xinh xắn kéo khóa cách điệu Yuumy Seasand YV97K màu kem</div>
                <div class="price">129,000đ <span class="old-price">220,000đ</span></div>
