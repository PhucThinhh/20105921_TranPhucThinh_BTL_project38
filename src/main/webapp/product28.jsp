    ...
    <form action="AddToCartServlet" method="post">
        ...
        <div class="container">
            <div class="product-image">
                <img src="img/25.jpg" alt="Product Image" width="500">
            </div>
            <div class="product-details">
                <div class="product-title">Ví da nữ mini dáng ngắn gấp gọn họa tiết vân đá thời trang Yuumy Seasand YV102K màu kem</div>
                <div class="price">85,000₫ <span class="old-price">130,000₫</span></div>
