...
<header>
	...
	<nav>
		<a href="new.jsp">Hàng Mới</a> <a href="products.jsp">Sản Phẩm</a> <a
			href="sale.jsp">Sale Off</a>  <a href="contact.jsp">Liên Hệ</a>
		<%
...
<form action="AddToCartServlet" method="post">
	...
	<input type="hidden" name="productName"
		value="Túi xách cầm tay đeo chéo da nữ dáng hến dễ thương Yuumy Seasand YN233XA màu xanh nhạt">
	<input type="hidden" name="productPrice" value="139000">

	<div class="container">
		<div class="product-image">
			<img src="img/9.jpg" alt="Product Image" width="500">
		</div>
		<div class="product-details">
			<div class="product-title">Túi xách cầm tay đeo chéo da nữ dáng
				hến dễ thương Yuumy Seasand YN233XA màu xanh nhạt</div>
			<div class="price">
				139,000đ <span class="old-price">220,000đ</span>
			</div>
			<div class="in-stock">Tình trạng: Còn 199 sản phẩm</div>
			<div class="select-color">
				<label for="color">Màu sắc:</label> <select id="color" name="color">
			...
			<div class="quantity">
				<label for="quantity">Chọn số lượng:</label> <input type="number"
					id="quantity" name="quantity" value="1" min="1">
			</div>
			<button type="submit" class="btn">THÊM VÀO GIỎ</button>
			<div class="description">
				<h3>Mô tả</h3>
				<p>Ví da nữ cầm tay mini Yuumy Seasaand YV105 có thiết kế nhỏ
					gọn bên ngoài, nhưng bên trong ví lại có đầy đủ ngăn đựng tiền mặt,
					thẻ ngân hàng, giấy tờ tùy thân và thậm chí là điện thoại. Với
					những gam màu nhẹ nhàng thanh lịch YV105 không chỉ là phụ kiện thời
					trang sang trọng để làm quà tặng, đi học, đi làm, dự tiệc mà còn là
					người bạn đồng hành không thể thiếu của các nàng.</p>
			</div>
			<div class="specs">
