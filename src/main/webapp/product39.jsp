    ...
    <form action="AddToCartServlet" method="post">
        ...
        <div class="container">
            <div class="product-image">
                <img src="img/36.jpg" alt="Product Image" width="500">
            </div>
            <div class="product-details">
                <div class="product-title">Túi đeo chéo da nữ nắp gập sành điệu Yuumy Seasand YN208D màu trắng</div>
                <div class="price">550,000đ <span class="old-price">329,000đ</span></div>
