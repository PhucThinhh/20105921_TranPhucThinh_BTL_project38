    ...
    <form action="AddToCartServlet" method="post">
        ...
        <div class="container">
            <div class="product-image">
                <img src="img/47.jpg" alt="Product Image" width="500">
            </div>
            <div class="product-details">
                <div class="product-title">Túi đeo chéo da nữ mini thanh lịch trẻ trung Yuumy Seasand YN237K màu kem</div>
                <div class="price">169,000đ <span class="old-price">250,000đ</span></div>
