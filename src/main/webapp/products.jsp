...
<body>
	...
	<div class="banner">
		<img src="img/banner.jpg" alt="Túi Xách Tay Nữ">
	</div>
	<div class="products">
		<div class="product">
			<a href="product1.jsp"> 
				<img src="img/1.jpg" alt="Túi xách cầm tay màu xanh nhạt">
				<p class="product-name">Túi xách cầm tay đeo chéo da nữ dáng hến dễ thương Yuummy Seasand YN233XA màu xanh nhạt</p>
				<p class="product-price">340,000₫</p>
			</a>
		</div>
		<div class="product">
			<a href="product2.jsp"> 
				<img src="img/2.jpg" alt="Túi xách cầm tay màu kem">
				<p class="product-name">Túi xách cầm tay đeo chéo da nữ dáng hến dễ thương Yuumy Seasand YN233K màu kem</p>
				<p class="product-price">340,000₫</p>
			</a>
		</div>
		<div class="product">
			<a href="product3.jsp"> 
				<img src="img/3.jpg" alt="Túi xách cầm tay màu đen">
				<p class="product-name">Túi xách cầm tay đeo chéo da nữ dáng hến dễ thương Yuummy Seasand YN233D màu đen</p>
				<p class="product-price">340,000₫</p>
			</a>
		</div>
		<div class="product">
			<a href="product4.jsp"> 
				<img src="img/4.jpg" alt="Túi xách da nữ màu đen">
				<p class="product-name">Túi xách da nữ chần chỉ kiểu dáng hiện đại Yuummy Seasand YTX52D màu đen</p>
				<p class="product-price"><span style="text-decoration: line-through;">520,000₫</span> 299,000₫</p>
			</a>
		</div>
	</div>
	<div class="products">
		<div class="product">
			<a href="product5.jsp"> 
				<img src="img/5.jpg" alt="Túi xách cầm tay màu xanh nhạt">
				<p class="product-name">Túi xách da nữ chần chỉ kiểu dáng hiện đại Yuumy Seasand YTX52HP màu hồng phấn</p>
				<p class="product-price"><span style="text-decoration: line-through;">520,000₫</span> 299,000₫</p>
			</a>
		</div>
		<div class="product">
			<a href="product6.jsp"> 
				<img src="img/6.jpg" alt="Túi xách cầm tay màu kem">
				<p class="product-name">Túi xách cầm tay đeo chéo da nữ dáng hến dễ thương Yuummy Seasand YN233K màu kem</p>
				<p class="product-price">340,000₫</p>
			</a>
		</div>
		<div class="product">
			<a href="product7.jsp"> 
				<img src="img/7.jpg" alt="Túi xách cầm tay màu đen">
				<p class="product-name">Túi xách cầm tay đeo chéo da nữ dáng hến dễ thương Yuummy Seasand YN233D màu đen</p>
				<p class="product-price">340,000₫</p>
			</a>
		</div>
		<div class="product">
			<a href="product8.jsp"> 
				<img src="img/8.jpg" alt="Túi xách da nữ màu đen">
				<p class="product-name">Túi xách cầm tay đeo chéo da nữ dáng hến dễ thương Yuummy Seasand YN233D màu đen</p>
				<p class="product-price">340,000₫</p>
			</a>
		</div>
		...
		<div class="product">
			<a href="product9.jsp"> 
				<img src="img/9.jpg" alt="Túi xách cầm tay màu xanh nhạt">
				<p class="product-name">Túi xách cầm tay đeo chéo da nữ dáng hến dễ thương Yuummy Seasand YN233XA màu xanh nhạt</p>
				<p class="product-price">340,000₫</p>
			</a>
		</div>
		<div class="product">
			<a href="product10.jsp"> 
				<img src="img/10.jpg" alt="Túi xách cầm tay màu kem">
				<p class="product-name">Túi xách cầm tay đeo chéo da nữ dáng hến dễ thương Yuummy Seasand YN233K màu kem</p>
				<p class="product-price">340,000₫</p>
			</a>
		</div>
		<div class="product">
			<a href="product11.jsp"> 
				<img src="img/11.jpg" alt="Túi xách cầm tay màu đen">
				<p class="product-name">Túi xách cầm tay đeo chéo da nữ dáng hến dễ thương Yuummy Seasand YN233D màu đen</p>
				<p class="product-price">340,000₫</p>
			</a>
		</div>
		<div class="product">
			<a href="product12.jsp"> 
				<img src="img/12.jpg" alt="Túi xách da nữ màu đen">
				<p class="product-name">Túi xách da nữ chần chỉ kiểu dáng hiện đại Yuummy Seasand YTX52D màu đen</p>
				<p class="product-price"><span style="text-decoration: line-through;">520,000₫</span> 299,000₫</p>
			</a>
		</div>
