    ...
    <form action="AddToCartServlet" method="post">
        ...
        <div class="container">
            <div class="product-image">
                <img src="img/45.jpg" alt="Product Image" width="500">
            </div>
            <div class="product-details">
                <div class="product-title">Túi xách cầm tay đeo chéo da nữ dáng
						hến dễ thương Yuummy Seasand YN233XA màu xanh nhạt</div>
                <div class="price">369,000đ <span class="old-price">660,000đ</span></div>
