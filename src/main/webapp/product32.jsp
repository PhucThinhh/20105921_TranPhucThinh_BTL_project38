    ...
    <form action="AddToCartServlet" method="post">
        ...
        <div class="container">
            <div class="product-image">
                <img src="img/29.jpg" alt="Product Image" width="500">
            </div>
            <div class="product-details">
                <div class="product-title">Túi đeo chéo da nữ kiểu dáng đơn giản trẻ trung Yuumy Seasand YN231K màu kem</div>
                <div class="price">360,000đ</div>
